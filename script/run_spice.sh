...
if [ ! -f /output/${filename}/${filename}.dat ]; then
	echo "File /output/${filename}/${filename}.dat not found"
	exit 1
fi

python3 /script/plotter.py /output/${filename}/${filename}.dat /output/${filename}/${filename}.png /output/${filename}/${filename}_sum.png
